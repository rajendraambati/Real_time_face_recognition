...
def detect_faces(image):
    ...
    if boxes is not None:
        ...
        for box ,face_embedding in zip(boxes ,embeddings):
            ...
            cv2.putText(image,label,(x1,y1-10),cv2.FONT_HERSHEY_SIMPLEX ,0.75,(0 ,255 ,0), 2)
...
def main():
    ...
    if option == "Train":
        ...
        folder_path = st.text_input("Enter path to images folder:", r'C:\Users\Calibrage27\PycharmProjects\Facial Recognition\ImagesAttendance')
